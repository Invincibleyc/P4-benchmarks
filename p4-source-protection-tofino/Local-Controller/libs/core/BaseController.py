...
class BaseController(object):
    ...
    def __init__(self, p4info_file_path=None, bmv2_path=None, prog_name=None, bin_path=None, cxt_json_path=None):
        self.__p4info_helper = utils.p4runtime_lib.helper.P4InfoHelper(p4info_file_path)
        self.__bmv2_file_path = bmv2_path
        self.__connection = None
        self.prog_name = prog_name
        self.bin_path = bin_path
        self.cxt_json_path = cxt_json_path
    ...
    def __add_switch_connection(self, name=None, address=None, device_id=None):
        ...
        :return: Bmv2SwitchConnection
        """
        switch = utils.p4runtime_lib.switch.SwitchConnection(name=name,
                                                       address=address,
                                                       device_id=device_id)
