...
parser.add_argument('--switch', help='Path to server JSON config file',
                    type=str, action="store", required=True)                    
parser.add_argument('--leader', help='Path to server JSON config file',
                    type=str, action="store", required=True)
parser.add_argument('--pbftswitch', help='Path to bftswitch JSON config file',
                    type=str, action="store", required=True)
...
class MyTopo(Topo):
    def __init__(self, sw_path, switch, leader, pbftswitch, client, **opts):
...
def main():
    topo = MyTopo(args.behavioral_exe, args.switch, 
                  args.leader, args.pbftswitch, args.client)
