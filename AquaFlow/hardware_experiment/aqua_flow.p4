...
typedef bit<18> enq_timestamp_t;
typedef bit<18> deq_timedelta_t;
...
control CodingIngress(inout headers hdr,
                  inout metadata meta, inout ingress_intrinsic_metadata_for_tm_t ig_tm_md, inout ingress_intrinsic_metadata_for_deparser_t ig_dprsr_md) {
 ...
 *************************************************************************/
control CodingEgress(inout headers hdr, inout ingress_intrinsic_metadata_t ig_intr_md,
                 inout metadata meta, out egress_intrinsic_metadata_t eg_intr_md, inout ingress_intrinsic_metadata_for_deparser_t ig_dprsr_md) {
    ...
    action add_switch_stats(switchID_t swid) {
        ...
        hdr.switch_stats[0].igt = (ingress_global_timestamp_t)ig_intr_md.ingress_mac_tstamp;
        hdr.switch_stats[0].enqt = (enq_timestamp_t)eg_intr_md.enq_tstamp;
        hdr.switch_stats[0].delt = (deq_timedelta_t)eg_intr_md.deq_timedelta;
    }
