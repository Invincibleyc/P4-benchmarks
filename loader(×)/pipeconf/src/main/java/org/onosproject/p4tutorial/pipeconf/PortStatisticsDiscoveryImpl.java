...
public final class PortStatisticsDiscoveryImpl extends AbstractHandlerBehaviour implements PortStatisticsDiscovery {
    ...
    public Collection<PortStatistics> discoverPortStatistics() {
        return new Collection<PortStatistics>() {
            @Override
            public int size() {
                return 0;
            }
            ...
            @Override
            public Iterator<PortStatistics> iterator() {
                return null;
            }
            ...
            @Override
            public boolean add(PortStatistics portStatistics) {
                return false;
            }
            ...
            @Override
            public boolean addAll(Collection<? extends PortStatistics> collection) {
                return false;
            }
